...
This document covers the active two-implementation release (Rust v1.3.0 at the repository root, Python v1.3.0 under `python/`). Items explicitly out of scope are recorded in the **Non-Requirements** section below. Items deferred to future releases are recorded in `docs/ROADMAP.md` rather than in this document.
