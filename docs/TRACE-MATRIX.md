...
| L2-CFG-006 | _(none)_ | `python/tests/test_config.py::test_case_insensitive`<br>`python/tests/test_config.py::test_invalid_raises`<br>`python/tests/test_config.py::test_non_str_entry_raises_cleanly`<br>`python/tests/test_config.py::test_should_exclude_by_bus`<br>`python/tests/test_config.py::test_should_exclude_by_rt`<br>`python/tests/test_config.py::test_should_exclude_by_subaddress`<br>`python/tests/test_config.py::test_should_exclude_by_type`<br>`python/tests/test_config.py::test_type_filter_active`<br>`python/tests/test_config.py::test_valid`<br>`src/filter.rs::exclude_by_rt`<br>`src/filter.rs::exclude_by_type_and_bus` | Implemented |
| L2-CFG-007 | _(none)_ | `python/tests/test_config.py::test_by_hex`<br>`python/tests/test_config.py::test_by_name`<br>`python/tests/test_config.py::test_case_insensitive`<br>`python/tests/test_config.py::test_hex_out_of_range_raises`<br>`python/tests/test_config.py::test_integer_codes_accepted`<br>`python/tests/test_config.py::test_integer_out_of_range_raises`<br>`python/tests/test_config.py::test_invalid_hex_raises`<br>`python/tests/test_config.py::test_invalid_name_raises`<br>`python/tests/test_config.py::test_non_str_non_int_raises`<br>`src/config.rs::type_name_parsing`<br>`src/config.rs::unknown_type_name_rejected` | Implemented |
...
| L2-ERR-008 | _(none)_ | `python/tests/test_config.py::test_cli_separate_is_default`<br>`src/writer.rs::error_path_naming` | Implemented |
| L2-ERR-011 | L3-PY-011, L3-RS-009 | `python/tests/test_config.py::test_cli_inline_errors_flag`<br>`python/tests/test_config.py::test_load_from_toml`<br>`tests/cli.rs::inline_errors_populates_error_code_column`<br>`tests/cli.rs::stdout_output_forces_inline_error_mode` | Implemented |
...
| L1 ID | L2 Children | Test Artifacts | Status |
|-------|-------------|----------------|--------|
| L1-ROB-001 | _(none)_ | `python/tests/test_e2e.py::test_arbitrary_bytes_never_raise_unexpected_exceptions`<br>`python/tests/test_e2e.py::test_dump_arbitrary_bytes_never_raise_unexpected_exceptions`<br>`python/tests/test_e2e.py::test_rt_to_rt_cmd2_overclaim_does_not_overrun`<br>`python/tests/test_merge.py::test_cli_manifest_missing_is_runtime_error`<br>`python/tests/test_merge.py::test_cli_manifest_non_utf8_is_runtime_error`<br>`python/tests/test_merge.py::test_read_manifest_tolerates_arbitrary_bytes`<br>`src/dump.rs::raw_dump_offset_max_length_max_does_not_panic`<br>`src/dump.rs::raw_dump_offset_max_length_one_does_not_panic`<br>`src/dump.rs::record_dump_offset_just_short_of_max_does_not_panic`<br>`src/dump.rs::record_dump_offset_max_does_not_panic`<br>`tests/integration.rs::dump_arbitrary_bytes_never_panics`<br>`tests/integration.rs::fuzz_arbitrary_bytes_never_panic`<br>`tests/integration.rs::merge_input_resolution_tolerates_arbitrary_bytes`<br>`tests/integration.rs::rt_to_rt_cmd2_overclaim_does_not_overrun` | Implemented |
...
| L2-MRG-006 | _(none)_ | `python/tests/test_merge.py::test_cli_merge_strict_flag_exits_1_on_backward_step`<br>`python/tests/test_merge.py::test_merge_strict_fails_on_within_file_backward_step`<br>`python/tests/test_merge.py::test_merge_warns_on_within_file_backward_step`<br>`tests/integration.rs::merge_strict_fails_on_within_file_backward_step`<br>`tests/integration.rs::merge_warns_on_within_file_backward_step` | Implemented |
