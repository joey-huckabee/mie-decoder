...
| L2-WRT-001 | L3-PY-004, L3-PY-012, L3-RS-004, L3-RS-012 | `python/tests/test_e2e.py::test_csv_header`<br>`python/tests/test_e2e.py::test_csv_row_count`<br>`python/tests/test_e2e.py::test_messages_to_dataframe`<br>`python/tests/test_e2e.py::test_write_csv_returns_count`<br>`python/tests/test_writer_streaming_golden.py::test_inline_file_output_is_byte_exact`<br>`python/tests/test_writer_streaming_golden.py::test_inline_stream_output_is_byte_exact`<br>`python/tests/test_writer_streaming_golden.py::test_split_output_is_byte_exact`<br>`python/tests/test_writer_streaming_primitives.py::test_streaming_writer_emits_header_on_construction`<br>`python/tests/test_writer_streaming_primitives.py::test_streaming_writer_streams_rows_incrementally`<br>`src/writer.rs::header_present`<br>`src/writer.rs::row_format_matches_python_layout`<br>`tests/cli.rs::decode_happy_path_writes_csv_with_header_and_one_row`<br>`tests/integration.rs::csv_output_has_one_row_per_message_plus_header` | Implemented |
