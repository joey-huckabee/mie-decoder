...
| L2-DEC-015 | _(none)_ | `src/decode.rs::probe_eight_irig_records_aggregates_decisively`<br>`src/decode.rs::probe_max_records_one_still_works`<br>`src/decode.rs::probe_single_irig_record_picks_irig`<br>`src/decode.rs::probe_stops_at_eof_records_probed_reflects_truncation`<br>`src/decode.rs::probe_zero_score_ties_to_irig`<br>`tests/cli.rs::detect_records_flag_accepts_valid_size`<br>`tests/cli.rs::detect_records_flag_rejects_out_of_range` | Implemented |
...
| L1 ID | L2 Children | Status |
|-------|-------------|--------|
| L1-ERR-001 | L2-ERR-001, L2-ERR-002, L2-ERR-003, L2-ERR-005, L2-ERR-006, L2-ERR-008, L2-ERR-011, L2-SYN-017, L2-SYN-024 | Partially Implemented |
...
| L2-ERR-011 | L3-PY-011, L3-RS-009 | `python/tests/test_config.py::test_cli_error_mode_inline`<br>`python/tests/test_config.py::test_load_from_toml`<br>`tests/cli.rs::inline_errors_populates_error_code_column` | Partially Implemented |
...
| L2-CFG-003 | _(none)_ | `python/tests/test_config.py::test_defaults`<br>`python/tests/test_config.py::test_with_overrides`<br>`src/config.rs::defaults_when_no_path`<br>`src/config.rs::overrides_apply_and_filter_merge` | Implemented |
