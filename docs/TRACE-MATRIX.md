...
| L2-SYN-026 | _(none)_ | `src/sync.rs::validate_lookahead_eof_terminates_gracefully`<br>`src/sync.rs::validate_lookahead_n1_skips_lookahead`<br>`src/sync.rs::validate_lookahead_n4_catches_second_corruption` | Implemented |
